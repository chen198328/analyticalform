...
namespace AnalyticalPlatform
{
    ...
    public partial class User : Entity<User>
    {
		...
		/// <summary>该User所拥有的Log集合</summary>
		[XmlIgnore]
        ...
        [NonSerialized]
		private EntityList<Tasks> _Taskss;
		/// <summary>该User所拥有的Tasks集合</summary>
		[XmlIgnore]
		public EntityList<Tasks> Taskss
		{
			get
			{
				if (_Taskss == null && id > 0 && !Dirtys.ContainsKey("Taskss"))
                {
					_Taskss = Tasks.FindAllByUserId(id);
					Dirtys["Taskss"] = true;
				}
				return _Taskss;
			}
        ...
        /// <summary>该User所对应的DataBase</summary>
        [XmlIgnore]
        public DataBase DataBase
        {
            get
            {
                if (_DataBase == null && DataBaseId > 0 && !Dirtys.ContainsKey("DataBase"))
                {
                     
                    _DataBase = DataBase.FindByid(DataBaseId);
                    Dirtys["DataBase"] = true;
                }
                return _DataBase;
            }
            set { _DataBase = value; }
        ...
        /// <summary>该User所对应的DataBaseName</summary>
        [XmlIgnore]
        public String DataBaseName { get { return DataBase != null ? DataBase.Name : null; } }
        #endregion
        ...
        public static User FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        /// <summary>根据DataBaseId查找</summary>
        /// <param name="databaseid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<User> FindAllByDataBaseId(Int32 databaseid)
        {
            if (Meta.Count >= 1000)
                return FindAll(_.DataBaseId, databaseid);
            else // 实体缓存
                return Meta.Cache.Entities.FindAll(_.DataBaseId, databaseid);
        }
        #endregion
