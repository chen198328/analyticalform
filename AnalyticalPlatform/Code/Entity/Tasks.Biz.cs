...
{
    /// <summary></summary>
    public partial class Tasks : Entity<Tasks>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(Tasks).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(Tasks).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        [NonSerialized]
        private User _User;
        /// <summary>该Tasks所对应的User</summary>
        [XmlIgnore]
        public User User
        {
            get
        ...
        /// <summary>该Tasks所对应的UserName</summary>
        [XmlIgnore]
        ...
        public static Tasks FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Tasks> FindAllByUserId(Int32 userid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Tasks> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
