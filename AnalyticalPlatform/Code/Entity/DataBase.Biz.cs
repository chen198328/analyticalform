...
namespace AnalyticalPlatform
{
    ...
    public partial class DataBase : Entity<DataBase>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(DataBase).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(DataBase).Name, Meta.Table.DataTable.DisplayName);
        //}
		...
		/// <summary>该DataBase所拥有的User集合</summary>
		[XmlIgnore]
		public EntityList<User> Users
		{
			get
			{
                ...
                {
					_Users = User.FindAllByDataBaseId(id);
					Dirtys["Users"] = true;
				}
				return _Users;
			}
        ...
        public static DataBase FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<DataBase> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
